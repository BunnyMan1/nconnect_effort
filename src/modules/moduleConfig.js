// Master configuration file for all modules
export const moduleConfig = {
    ...
    FeedbackForms: {
        name: 'Feedback Forms & WEF',
        futureImpact: { x: 30, y: 85 },
        currentImpact: { x: 70, y: 10 },
        description: 'Feedback Forms & WEF',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    AdoptionCallingAI: {
    ...
    AIHRCalling: {
        name: 'AI HR Calling',
        futureImpact: { x: 20, y: 80 },
        currentImpact: { x: 70, y: 5 },
        description: 'AI HR Calling',
        notes: 'Add your notes, action items, or observations here...',
    ...
    AITutor: {
        name: 'AI Tutor',
        futureImpact: { x: 60, y: 98 },
        currentImpact: { x: 98, y: 5 },
        description: 'AI Tutor',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    GatePassEnhancements: {
        name: 'Gate Pass Enhancements',
        futureImpact: { x: 15, y: 80 },
        currentImpact: { x: 40, y: 15 },
        description: 'Gate Pass Enhancements',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    SoftSkillsInMS: {
        name: 'Soft Skills in MS',
        futureImpact: { x: 20, y: 80 },
        currentImpact: { x: 55, y: 15 },
        description: 'Soft Skills in MS',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    ReportsFixesDataAdditions: {
        name: 'Reports, Fixes, Data Additions across high usage modules',
        futureImpact: { x: 60, y: 80 },
        currentImpact: { x: 75, y: 70 },
        description: 'Reports, Fixes, Data Additions across high usage modules',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    ...
    TPTByIB: {
        name: 'TPT by IB',
        futureImpact: { x: 20, y: 70 },
        currentImpact: { x: 65, y: 10 },
        description: 'TPT by IB',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'dotted'
    },
    AIHRDemoEvaluation: {
        name: 'AI HR Demo Evaluation',
        futureImpact: { x: 20, y: 80 },
        currentImpact: { x: 75, y: 10 },
        description: 'AI HR Demo Evaluation',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'dotted'
    },
    MultiLingualOnParentApp: {
        name: 'Multi Lingual on Parent App',
        futureImpact: { x: 10, y: 80 },
        currentImpact: { x: 40, y: 50 },
        description: 'Multi Lingual on Parent App',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    LDComments: {
    ...
    Payroll15: {
        ...
        currentImpact: { x: 95, y: 95 },
        description: 'Payroll 1.5',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    FrameworkUpgrades: {
    ...
    Documentation: {
        name: 'Documentation',
        futureImpact: { x: 30, y: 98 },
        currentImpact: { x: 90, y: 90 },
        description: 'Documentation',
        notes: 'Add your notes, action items, or observations here...',
        connectingLineStyle: 'solid'
    },
    Pipeline: {
        name: 'Pipeline / Future',
        type: 'pipeline',
        description: 'Pipeline - Future Projects',
        notes: 'Manage your upcoming projects and ideas'
    },
};
...
// Helper function to get plot dimensions
